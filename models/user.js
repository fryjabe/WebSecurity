    ...
    async sendEmail(email, activationString) {
        ...
        nodemailer.createTestAccount((err, account) => {
            ...
            let mailOptions = {
                ...
                html: `<b>In order to activate your account you need to access the following link</b> <a href="http://${config.link}/users/activation/${activationString}">Activation link</a>`
            }
